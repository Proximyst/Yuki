...
impl ClientInterface {
    ...
    pub fn get_all_classes(&self) -> Result<*const usize> {
        ...
        Ok(unsafe { std::mem::transmute::<_, Func>(self.inner.nth(ClientVTableIndicies::GetAllClasses as isize)?)(*self.inner.handle()) })
    }
    ...
    pub fn dispatch_user_message(
        ...
        Ok(unsafe {
            std::mem::transmute::<_, Func>(self.inner.nth(ClientVTableIndicies::DispatchUserMessage as isize)?)(
                *self.inner.handle(),
                message_type,
                par1,
                par2,
